<template>
  <HeaderComponent title="Welcome to Media-Tracker
">
  </HeaderComponent>
  ...
  <ButtonText class="mt-n1 mb-3" color="indigo" text="All Characters" to="/characters" />
  ...
  <MediaComponent :media="orderBy(movies, ['updatedAt'], ['desc']).slice(0, 20)" :media-type="EMediaType.MOVIE"
    title="Recent Movies" />
  <ButtonText class="mt-n1 mb-3" color="indigo" text="All Movies" to="/movies" />
  <LinksComponent />
</template>
